package ejercicio_sucursales;

import Clases.Conect;
...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnEnter.setFont(new java.awt.Font("Eras Bold ITC", 1, 18)); // NOI18N
        ...
        btnExit.setFont(new java.awt.Font("Eras Bold ITC", 1, 18)); // NOI18N
    ...
    private void btnEnterMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEnterMouseEntered
        ...
        btnEnter.setForeground(new Color(51,255,0));
    ...
    private void btnExitMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnExitMouseEntered
        ...
        btnExit.setForeground(new Color(51,255,0));
    ...
    private void ValidUser(){
        try{
            cone = new Conect("sucursal");
            String sql = "select * from usuarios where Nombre ='" + txtUser.getText().trim() + "' and Pass ='" + txtPass.getText() + "'";
            con = cone.getConexion();
            ps = con.prepareStatement(sql);
            rs = ps.executeQuery();
            if(rs.next()){
                new Princiapl(rs.getInt("Acces"),rs.getString("Nombre")).setVisible(true);
                con.close();
                this.dispose();
            } else{
                met.Msg("Error datos incorrectos");
                met.Clean(jPanel1);
            }
        }catch(Exception e){
            met.Msg("Error"+e);
    ...
    private void txtUserKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtUserKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER) txtPass.requestFocus();
    }//GEN-LAST:event_txtUserKeyPressed

    private void txtPassKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPassKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER) btnEnter.requestFocus();
    }//GEN-LAST:event_txtPassKeyPressed

    private void btnEnterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnEnterKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER) ValidUser();
